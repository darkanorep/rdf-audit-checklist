...
class ReferenceNumberService
{
    ...
    public function generate(string $location): string
    {
        ...
        $last = Copy::where('reference_number', 'like', "{$prefix}-%")
        ...
        return sprintf('%s-%s', $prefix, str_pad((string) $nextNumber, self::PAD_LENGTH, '0', STR_PAD_LEFT));
        // Note: if a location ever exceeds 9999 in a single year, this naturally
        // becomes DPT-10000 (5 digits) rather than throwing — acceptable, but
